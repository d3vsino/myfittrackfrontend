<template>
  <div class="flex h-[calc(100vh-120px)]">
    <!-- Chat sidebar (like ChatGPT) -->
    <div 
      class="w-64 bg-gray-50 border-r border-gray-200 h-full overflow-hidden transition-all duration-300 flex flex-col"
    ...
    <div class="flex-1 flex flex-col overflow-hidden relative">
      ...
      <button 
        ...
        class="md:hidden absolute top-2 left-2 z-10 p-2 rounded-md bg-white shadow-md"
      >
      ...
      <!-- Chat header -->
      <div class="p-4 border-b border-gray-200 flex justify-between items-center">
        <h1 class="text-xl font-bold text-blue-600 ml-10 md:ml-0">AI Nutritionist</h1>
